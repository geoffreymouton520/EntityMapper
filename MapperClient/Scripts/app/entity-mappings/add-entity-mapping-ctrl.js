(function () {
    ...
    var addEntityMappingCtrl = function (entityMapping, $state, domainResource, systemResource, entityResource) {
        var vm = this;
        ...
        vm.submit = function (isValid) {
            if (isValid) {
                vm.entityMapping.$save(successfullyAdded, failedToAdded);
            } else {
    ...
    mapperClient.controller("addEntityMappingCtrl", ["entityMapping", "$state", "domainResource", "systemResource", "entityResource", addEntityMappingCtrl]);
})();
